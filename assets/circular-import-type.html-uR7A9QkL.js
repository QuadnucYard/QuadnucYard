import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as o,o as p,c as l,b as n,d as s,e,a as c,f as t}from"./app-YJ_h_pZv.js";const d={},u=n("h1",{id:"python-typing-遇到循环导入",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#python-typing-遇到循环导入","aria-hidden":"true"},"#"),s(" Python typing 遇到循环导入")],-1),r=n("p",null,"Python 有着和 C++ 极为相似的 import 系统，都是 include once。这样就很容易产生循环包含/导入的问题。",-1),m=n("p",null,"从依赖关系角度，确实可以通过将依赖关系构建成树的方式来避免循环导入。但是当使用 typing 的时候，情况就不一样了……",-1),v=n("h2",{id:"测试环境配置",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#测试环境配置","aria-hidden":"true"},"#"),s(" 测试环境配置")],-1),k=n("p",null,"Ubuntu 22.04，配置 conda。",-1),y={href:"https://mirrors.tuna.tsinghua.edu.cn/anaconda/miniconda/",target:"_blank",rel:"noopener noreferrer"},b={href:"https://mirrors.tuna.tsinghua.edu.cn/anaconda/miniconda/Miniconda3-latest-Linux-x86_64.sh",target:"_blank",rel:"noopener noreferrer"},h=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">wget</span> https://mirrors.tuna.tsinghua.edu.cn/anaconda/miniconda/Miniconda3-latest-Linux-x86_64.sh
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>换到 3.11 就没这么多问题了，涉及 <code>TYPE_CHECKING</code> 的类型，理论上不加引号是可以的，但是如果提示 <code>NameError</code>，那就把 <code>import annotations</code> 加上吧……</p>`,20);function w(x,E){const a=o("ExternalLinkIcon");return p(),l("div",null,[u,r,m,v,k,n("p",null,[s("从 "),n("a",y,[s("清华源"),e(a)]),s(" 安装，直接下载 "),n("a",b,[s("latest"),e(a)]),s(" 就行。")]),h,n("p",null,[s("解决方法参考了 "),n("a",g,[s("https://adamj.eu/tech/2021/05/13/python-type-hints-how-to-fix-circular-imports/"),e(a)]),s("。"),f,s(" 源于一个思想：我如何让 import 只用于静态分析，让分析器找到注解的类型？运行期并不需要这个导入。")]),_,c(" （切换环境后需要 Restart language server） ")])}const N=i(d,[["render",w],["__file","circular-import-type.html.vue"]]);export{N as default};
